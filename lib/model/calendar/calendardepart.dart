...
class CalendarDepart
{
  ...
  List<CalendarDepartFile> calendarDepartFiles;
  CalendarDepart({
    required this.id,
    ...
    required this.calendarDepartFiles
  });
  factory CalendarDepart.fromJson(Map<String, dynamic>? json) {
    return CalendarDepart(
        ...
        calendarDepartFiles: json!= null &&  json['calendarDepartFiles']!=null? (json['calendarDepartFiles'] as List)
            .map((data) => CalendarDepartFile.fromJson(data))
            .toList(): []
    );
  }
}
