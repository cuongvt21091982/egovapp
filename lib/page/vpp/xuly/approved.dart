...
class PheDuyetDangKy extends StatefulWidget
{
  const PheDuyetDangKy({Key? key,
    required this.id,
    required this.title,
  ...
  @override
  _PheDuyetDangKyState createState() => _PheDuyetDangKyState();}
class _PheDuyetDangKyState extends State<PheDuyetDangKy>
{
  ...
  Future<void> actionForm() async
  {
    ...
    ServiceDangKy().approved(this.widget.id,
        dangKy!.ngay,
        dangKy!.ghiChu,
        dangKy!.phongID,
        dangKy!.noiDung,
