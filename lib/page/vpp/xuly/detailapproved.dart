...
import 'package:egovapp/page/vpp/xuly/approved.dart';
import 'package:egovapp/service/vpp/service-dangky.dart';
import 'package:flutter/material.dart';
class DangKyDetailApproved extends StatefulWidget
{
  const DangKyDetailApproved({Key? key, required this.id,
    required this.chuDe,
  ...
  final String chuDe;
  @override
  _DangKyDetailApprovedState createState() => _DangKyDetailApprovedState();
}
class _DangKyDetailApprovedState extends State<DangKyDetailApproved>
{
  String chuDe = '';
  @override
  void initState(){
                              ...
                              children: [
                                Container(
                                    ...
                                    TextButton.icon(onPressed: () async {
                                      Navigator.push(context, new MaterialPageRoute(builder: (context) => new PheDuyetDangKy(id: this.widget.id,
