...
import 'package:egovapp/page/vpp/xuly/detailapproved.dart';
import 'package:egovapp/service/vpp/service-dangky.dart';
import 'package:flutter/material.dart';
import 'package:infinite_scroll_pagination/infinite_scroll_pagination.dart';
class VPPDuyetYeuCau extends StatefulWidget
{
  const VPPDuyetYeuCau({Key? key}) : super(key: key);
  @override
  _VPPDuyetYeuCauState createState() => _VPPDuyetYeuCauState();
}
class _VPPDuyetYeuCauState extends State<VPPDuyetYeuCau>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceDangKy().getPagingPheDuyet(keyword,thietBiId,status, UserAuthSession.staffId,page, size).then((value)
    {
      try {
        ...
        builderDelegate: PagedChildBuilderDelegate<DangKy>(
            ...
            itemBuilder: (context, item, index) =>  ListTile(
                ...
                onTap: (){
                  ...
                  new DangKyDetailApproved(id: item.dangKyId, chuDe: item.noiDung, callBackRefresh: () =>
                      setState((){  search();})
                  )));
