...
class AssignYeuCau extends StatefulWidget
{
  const AssignYeuCau({Key? key,
    required this.id,
    required this.title,
  ...
  final int id;
  @override
  _AssignYeuCauState createState() => _AssignYeuCauState();}
class _AssignYeuCauState extends State<AssignYeuCau>
{
  ...
  Future<void> actionForm() async
  {
    ...
    final dialogContext = await dialogContextCompleter.future;
      ServiceYeuCau().joinYeuCau(this.widget.id, this.staffsSelect.map((e) => e.id).toList().join(',')).then((value) {
