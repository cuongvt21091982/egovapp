...
class YeuCauNoiDungTrinh extends StatefulWidget
{
  const  YeuCauNoiDungTrinh({Key? key, required this.id, required this.title}) : super(key: key);
  final int id;
  final String title;
  @override
  _TYeuCauNoiDungTrinhState createState() => _TYeuCauNoiDungTrinhState();
}
class _TYeuCauNoiDungTrinhState extends State<YeuCauNoiDungTrinh> {
