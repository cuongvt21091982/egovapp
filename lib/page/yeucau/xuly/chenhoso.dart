...
class YeuCauChenHoSo extends StatefulWidget
{
  const YeuCauChenHoSo({Key? key, required this.id}) : super(key: key);
  final int id;
  @override
  _YeuCauChenHoSoState createState() => _YeuCauChenHoSoState();
}
class _YeuCauChenHoSoState extends State<YeuCauChenHoSo>
{
  ...
  dynamic _insertHoSo() async
  {
    ...
    ServiceYeuCau().chenHoSo(this.widget.id, this.hoSoId).then((value){
