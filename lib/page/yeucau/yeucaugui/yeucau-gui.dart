...
class YeuCauGui extends StatefulWidget
{
  const YeuCauGui({Key? key}) : super(key: key);
  @override
  YeuCauGuiState createState() => YeuCauGuiState();
}
class YeuCauGuiState extends State<YeuCauGui>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceYeuCau().getPaging(keyword,ParamUtils.statusArrayAll,UserAuthSession.staffId, ParamUtils.valueDefault, ParamUtils.dateDefault,ParamUtils.dateDefault, page, size).then((value)
    {
      try {
