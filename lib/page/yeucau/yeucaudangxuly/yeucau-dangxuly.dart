...
class YeuCauDangXuLy extends StatefulWidget
{
  const YeuCauDangXuLy({Key? key}) : super(key: key);
  @override
  _YeuCauDangXuLyState createState() => _YeuCauDangXuLyState();
}
class _YeuCauDangXuLyState extends State<YeuCauDangXuLy>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceYeuCauXuLy().getPaging(keyword,ParamUtils.statusDangXuLy.toString(),UserAuthSession.staffId, ParamUtils.valueDefault, ParamUtils.dateDefault,ParamUtils.dateDefault, page, size).then((value)
    {
      try {
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("giaoviecdangxuly"),
