...
class YeuCauChuaXuLy extends StatefulWidget
{
  const YeuCauChuaXuLy({Key? key}) : super(key: key);
  @override
  _YeuCauChuaXuLyState createState() => _YeuCauChuaXuLyState();
}
class _YeuCauChuaXuLyState extends State<YeuCauChuaXuLy>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceYeuCauXuLy().getPaging(keyword,ParamUtils.statusChuaXuLy.toString(),UserAuthSession.staffId, ParamUtils.valueDefault, ParamUtils.dateDefault,ParamUtils.dateDefault, page, size).then((value)
    {
      try {
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("giaoviecchuaxuly"),
