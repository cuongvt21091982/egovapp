...
class YeuCauHoanThanh extends StatefulWidget
{
  const YeuCauHoanThanh({Key? key}) : super(key: key);
  @override
  _YeuCauHoanThanhState createState() => _YeuCauHoanThanhState();
}
class _YeuCauHoanThanhState extends State<YeuCauHoanThanh>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceYeuCauXuLy().getPaging(keyword,ParamUtils.statusHoanThanh.toString(),UserAuthSession.staffId, ParamUtils.valueDefault, ParamUtils.dateDefault,ParamUtils.dateDefault, page, size).then((value)
    {
      try {
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("giaoviechoanthanh"),
