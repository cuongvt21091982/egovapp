...
import 'package:egovapp/page/hoso/donvi/xuly/share.dart';
...
class AppBarHoSoXuLyAction extends StatefulWidget {
  const AppBarHoSoXuLyAction({Key? key, required this.id,
    required this.title,
  ...
  final String title;
  @override
  _AppBarHoSoXuLyActionState createState() => _AppBarHoSoXuLyActionState();
}

class _AppBarHoSoXuLyActionState extends State<AppBarHoSoXuLyAction> {
            ...
            PopupMenuButton(
                ...
                onSelected: (String value) async{
                  if(value==ParamUtils.actionUpdate) {
                    Navigator.push(context, new MaterialPageRoute(builder: (context) => new EditHoSoDonVi(id: this.widget.id,
                        title: Language.getText('capnhathosodonvi'), callBackRefresh: () =>
                            setState((){ })
                    )),);
                  }
                  ...
                  if(value==ParamUtils.actionSumComment) {
                    Navigator.push(
                        context,
                        MaterialPageRoute<void>(
                          builder: (BuildContext context) => HoSoYKienTongHopDialog(id: this.widget.id, title: this.widget.title),
                          fullscreenDialog: true,
                        ));
                  }
                  if(value==ParamUtils.actionShare) {
                    Navigator.push(
                        context,
                        MaterialPageRoute<void>(
                          builder: (BuildContext context) => ShareHoSoDonVi(id: this.widget.id, title: this.widget.title),
                          fullscreenDialog: true,
                        ));
                  }
