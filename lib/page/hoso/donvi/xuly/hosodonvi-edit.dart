...
class EditHoSoDonVi extends StatefulWidget
{
  const EditHoSoDonVi({Key? key,
    required this.id,
    required this.title,
  ...
  final int id;
  @override
  _EditHoSoDonViState createState() => _EditHoSoDonViState();}
class _EditHoSoDonViState extends State<EditHoSoDonVi>
{
  HtmlEditorController controller = HtmlEditorController();
  TextEditingController  txtTenHoSo =  TextEditingController();
  List<FileItem> fileUploads= [];
  int status = ParamUtils.hoSoDonVi;
