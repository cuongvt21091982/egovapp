...
class ShareHoSoCaNhan extends StatefulWidget
{
  const ShareHoSoCaNhan({Key? key,
    required this.id,
    required this.title
  }) : super(key: key);
  ...
  final int id;
  @override
  _ShareHoSoCaNhanState createState() => _ShareHoSoCaNhanState();}
class _ShareHoSoCaNhanState extends State<ShareHoSoCaNhan>
{
