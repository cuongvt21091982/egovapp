...
import 'package:egovapp/page/datphong/xuly/detail.dart';
import 'package:egovapp/service/vpp/service-dangkyhop.dart';
import 'package:flutter/material.dart';
import 'package:infinite_scroll_pagination/infinite_scroll_pagination.dart';
class DatPhongTheoDoiYeuCau extends StatefulWidget
{
  const DatPhongTheoDoiYeuCau({Key? key}) : super(key: key);
  @override
  _DatPhongTheoDoiYeuCauState createState() => _DatPhongTheoDoiYeuCauState();
}
class _DatPhongTheoDoiYeuCauState extends State<DatPhongTheoDoiYeuCau>
{
  int page = Enviroments.currentPage;
  int size= Enviroments.pageSize;
  int phongId=ParamUtils.valueDefault;
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceDangKyHop().getPaging(keyword,phongId,status, UserAuthSession.staffId,page, size).then((value)
    {
      try {
        ...
        builderDelegate: PagedChildBuilderDelegate<DangKyHop>(
            ...
            itemBuilder: (context, item, index) =>  ListTile(
                ...
                onTap: (){
                  ...
                  new DangKyDatPhongDetail(id: item.dangKyId, chuDe: item.noiDung, callBackRefresh: () =>
                      setState((){  search();})
                  )));
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("theodoiyeucau"),
