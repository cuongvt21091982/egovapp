...
class DatPhongXemKetQua extends StatefulWidget
{
  const DatPhongXemKetQua({Key? key}) : super(key: key);
  @override
  _DatPhongXemKetQuaState createState() => _DatPhongXemKetQuaState();
}
class _DatPhongXemKetQuaState extends State<DatPhongXemKetQua>
{
