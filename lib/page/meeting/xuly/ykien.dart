...
import 'package:egovapp/service/meeting/service-meetingfilexl.dart';
import 'package:egovapp/service/meeting/service-meetingxuly.dart';
import 'package:flutter/material.dart';
import 'package:html_editor_enhanced/html_editor.dart';
class YKienMeeting extends StatefulWidget
{
  const YKienMeeting({Key? key,
    required this.id,
    required this.title
  }) : super(key: key);
  final String title;
  final int id;
  @override
  _YKienMeetingState createState() => _YKienMeetingState();}
class _YKienMeetingState extends State<YKienMeeting>
{
  ...
  Future<void> actionForm() async
  {
    ...
    ServiceMeetingXuLy().updateXuLy(this.widget.id,valueContent, status, UserAuthSession.staffId,0 ).then((value) {
      ...
      for(var f in fileUploads)
      {
        ...
        {
          ServiceMeetingFileXL().add(value, f.path!);
        }
      }
                  ...
                  children: [
                    Container(
                        ...
                        TextButton.icon(onPressed: () async {
                          ...
                          label: UIUtils.setButtonResetText(Language.getText("ketthuc")
                          ),
