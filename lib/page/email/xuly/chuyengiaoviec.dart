...
import 'package:egovapp/page/email/xuly/noidungtrinh.dart';
...
class ThuChuyenGiaoViec extends StatefulWidget
{
  const ThuChuyenGiaoViec({Key? key,
    required this.id,
    required this.title
  }) : super(key: key);
  ...
  final int id;
  @override
  _ThuChuyenGiaoViecState createState() => _ThuChuyenGiaoViecState();}
class _ThuChuyenGiaoViecState extends State<ThuChuyenGiaoViec>
{
  ...
  Future<void> actionForm() async
  {
    ...
    if(this.widget.id ==0) {
      ServiceYeuCau().add(
        ...
        ServiceThu().chuyenGiaoViec(value.id, this.widget.id, UserAuthSession.staffId).catchError((e) {
                      ...
                      TextButton.icon(onPressed: () async {
                        Navigator.push(
                            ...
                            MaterialPageRoute<void>(
                              builder: (BuildContext context) => ThuNoiDungTrinh(id: this.widget.id, title: Language.getText("noidunggiaoviec")),
