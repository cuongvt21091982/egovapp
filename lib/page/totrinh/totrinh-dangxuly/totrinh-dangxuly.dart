...
class ToTrinhDangXuLy extends StatefulWidget
{
  const ToTrinhDangXuLy({Key? key}) : super(key: key);
  @override
  ToTrinhDangXuLyState createState() => ToTrinhDangXuLyState();
}
class ToTrinhDangXuLyState extends State<ToTrinhDangXuLy>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceToTrinhXuLy().getPaging(keyword,ParamUtils.statusDangXuLy.toString(),UserAuthSession.staffId, ParamUtils.valueDefault, ParamUtils.dateDefault,ParamUtils.dateDefault, page, size).then((value)
    {
      try {
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("totrinhdangxuly"),
