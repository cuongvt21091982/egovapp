...
class ChangeDateToTrinh
{
    ChangeDateToTrinh({required this.context, required this.id, required this.callBackRefresh});
    ...
    void action() async
    {
      ...
      ServiceToTrinh().changeThoiHan(id, dtThoiHan.text).then((value) {
    ...
    void showChange()
    {
      ServiceToTrinh().getById(this.id).then((value){
