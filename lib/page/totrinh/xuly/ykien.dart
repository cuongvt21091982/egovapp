...
import 'package:egovapp/service/totrinh/service-totrinhfilenxl.dart';
import 'package:egovapp/service/totrinh/service-totrinhxuly.dart';
import 'package:flutter/material.dart';
import 'package:html_editor_enhanced/html_editor.dart';
class YKienToTrinh extends StatefulWidget
{
  const YKienToTrinh({Key? key,
    required this.id,
    required this.title
  }) : super(key: key);
  final String title;
  final int id;
  @override
  _YKienToTrinhState createState() => _YKienToTrinhState();}
class _YKienToTrinhState extends State<YKienToTrinh>
{
  ...
  Future<void> actionForm() async
  {
    ...
    ServiceToTrinhXuLy().updateXuLy(this.widget.id,valueContent, status, UserAuthSession.staffId  ).then((value) {
      ...
      for(var f in fileUploads)
      {
        ...
        {
          ServiceToTrinhFileNXL().add(value, f.path!);
        }
      }
