...
class ToTrinhNoiDungTrinh extends StatefulWidget
{
  const  ToTrinhNoiDungTrinh({Key? key, required this.id, required this.title}) : super(key: key);
  final int id;
  final String title;
  @override
  _ToTrinhNoiDungTrinhState createState() => _ToTrinhNoiDungTrinhState();
}
class _ToTrinhNoiDungTrinhState extends State<ToTrinhNoiDungTrinh> {
