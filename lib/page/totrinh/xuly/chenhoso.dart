...
class ToTrinhChenHoSo extends StatefulWidget
{
  const ToTrinhChenHoSo({Key? key, required this.id}) : super(key: key);
  final int id;
  @override
  _ToTrinhChenHoSoState createState() => _ToTrinhChenHoSoState();
}
class _ToTrinhChenHoSoState extends State<ToTrinhChenHoSo>
{
  ...
  dynamic _insertHoSo() async
  {
    ...
    ServiceToTrinh().chenHoSo(this.widget.id, this.hoSoId).then((value){
