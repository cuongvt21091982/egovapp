...
import 'package:egovapp/page/totrinh/xuly/detail.dart';
import '../xuly/edittotrinh.dart';
import 'package:egovapp/service/totrinh/service-totrinh.dart';
import 'package:flutter/material.dart';
import 'package:infinite_scroll_pagination/infinite_scroll_pagination.dart';
class ToTrinhGui extends StatefulWidget
{
  const ToTrinhGui({Key? key}) : super(key: key);
  @override
  ToTrinhGuiState createState() => ToTrinhGuiState();
}
class ToTrinhGuiState extends State<ToTrinhGui>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceToTrinh().getPaging(keyword,ParamUtils.statusArrayAll,UserAuthSession.staffId, ParamUtils.valueDefault, ParamUtils.dateDefault,ParamUtils.dateDefault, page, size).then((value)
          {
            try {
      ...
      builderDelegate: PagedChildBuilderDelegate<ToTrinh>(
        ...
        itemBuilder: (context, item, index) =>  ListTile(
          ...
          onTap: (){
            ...
            new ToTrinhDetail(id: item.id, chuDe: item.chuDe, callBackRefresh: () =>
              setState((){  searchToTrinh();})
            )));
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("totrinhgui"),
