...
class ToTrinhChuaXuLy extends StatefulWidget
{
  const ToTrinhChuaXuLy({Key? key}) : super(key: key);
  @override
  ToTrinhChuaXuLyState createState() => ToTrinhChuaXuLyState();
}
class ToTrinhChuaXuLyState extends State<ToTrinhChuaXuLy>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceToTrinhXuLy().getPaging(keyword,ParamUtils.statusChuaXuLy.toString(),UserAuthSession.staffId, ParamUtils.valueDefault, ParamUtils.dateDefault,ParamUtils.dateDefault, page, size).then((value)
    {
      try {
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("totrinhchuaxuly"),
