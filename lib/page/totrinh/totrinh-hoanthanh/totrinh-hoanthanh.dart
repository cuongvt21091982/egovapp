...
class ToTrinhHoanThanh extends StatefulWidget
{
  const ToTrinhHoanThanh({Key? key}) : super(key: key);
  @override
  ToTrinhHoanThanhState createState() => ToTrinhHoanThanhState();
}
class ToTrinhHoanThanhState extends State<ToTrinhHoanThanh>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceToTrinhXuLy().getPaging(keyword,ParamUtils.statusHoanThanh.toString(),UserAuthSession.staffId, ParamUtils.valueDefault, ParamUtils.dateDefault,ParamUtils.dateDefault, page, size).then((value)
    {
      try {
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("totrinhhoanthanh"),
