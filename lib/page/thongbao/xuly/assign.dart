...
class AssignThongBao extends StatefulWidget
{
  const AssignThongBao({Key? key,
    required this.id,
    required this.title,
  ...
  final int id;
  @override
  _AssignThongBaoState createState() => _AssignThongBaoState();}
class _AssignThongBaoState extends State<AssignThongBao>
{
  ...
  Future<void> actionForm() async
  {
    ...
    ServiceThongBaoNguoiDoc().addMulti(this.widget.id, this.staffsSelect.map((e) => e.id).toList().join(',')).then((value) {
    ...
    var formEdit=Form(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            Container(
              child: UIStaffSelect(staffsSelect:  this.staffsSelect, titleAction:  Language.getText('select_nguoidoc')) ,
                        ...
                        child: TextButton.icon(onPressed: () async{
                          ...
                          if (formKey.currentState!.validate()) {
                            UIAction(actionForm).showDialogConfirm(context,
                                Language.getText('assign_staff_thongbao_question'));
                          }
                        },
                          style:UIUtils.setButtonSubmitStyle(),
                          icon: UIUtils.setButtonIcon(Icons.save) ,
                          label: UIUtils.setButtonSubmitText(Language.getText("assign_staff_thongbao")
                          ),
