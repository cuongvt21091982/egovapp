...
class QLThongBao extends StatefulWidget
{
  const QLThongBao({Key? key}) : super(key: key);
  @override
  _QLThongBaoState createState() => _QLThongBaoState();
}
class _QLThongBaoState extends State<QLThongBao>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceThongBao().getPagingByQL(keyword,UserAuthSession.staffId,page, size).then((value)
    {
      try {
