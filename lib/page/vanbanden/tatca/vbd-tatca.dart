...
class VBDenTatCa extends StatefulWidget
{
  const VBDenTatCa({Key? key}) : super(key: key);
  @override
  _VBDenTatCaState createState() => _VBDenTatCaState();
}
class _VBDenTatCaState extends State<VBDenTatCa>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceVanBanDen().getPagingXuLy(keyword,maLoaiVB,maLinhVuc,ParamUtils.valueDefault.toString(),
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("tatcavanbanden"),
