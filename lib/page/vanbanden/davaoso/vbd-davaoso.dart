...
class VBDenDaVaoSo extends StatefulWidget
{
  const VBDenDaVaoSo({Key? key}) : super(key: key);
  @override
  _VBDenDaVaoSoState createState() => _VBDenDaVaoSoState();
}
class _VBDenDaVaoSoState extends State<VBDenDaVaoSo>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceVanBanDen().getPaging(keyword,maLoaiVB,maLinhVuc,ParamUtils.valueDefault.toString(),
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("vanbandendavaoso"),
