...
class VBDenChuaXuLy extends StatefulWidget
{
  const VBDenChuaXuLy({Key? key}) : super(key: key);
  @override
  _VBDenChuaXuLyState createState() => _VBDenChuaXuLyState();
}
class _VBDenChuaXuLyState extends State<VBDenChuaXuLy>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceVanBanDen().getPagingXuLy(keyword,maLoaiVB,maLinhVuc,ParamUtils.statusChuaXuLy.toString(),
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("vanbandenchuaxuly"),
