...
class ChangeDateVanBanDen
{
  ChangeDateVanBanDen({required this.context, required this.id, required this.callBackRefresh});
  ...
  void action() async
  {
    ...
    ServiceVanBanDen().changeThoiHan(id, dtThoiHan.text).then((value) {
  ...
  void showChange()
  {
    ServiceVanBanDen().getById(this.id).then((value){
