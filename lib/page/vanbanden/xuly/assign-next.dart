...
class AssignNextVanBanDen extends StatefulWidget
{
  const AssignNextVanBanDen({Key? key,
    required this.id,
    required this.title,
  ...
  final int id;
  @override
  _AssignNextVanBanDenState createState() => _AssignNextVanBanDenState();}
class _AssignNextVanBanDenState extends State<AssignNextVanBanDen>
{
