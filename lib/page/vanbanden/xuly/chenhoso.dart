...
class VanBanDenChenHoSo extends StatefulWidget
{
  const VanBanDenChenHoSo({Key? key, required this.id}) : super(key: key);
  final int id;
  @override
  _VanBanDenChenHoSoState createState() => _VanBanDenChenHoSoState();
}
class _VanBanDenChenHoSoState extends State<VanBanDenChenHoSo>
{
  ...
  dynamic _insertHoSo() async
  {
    ...
    ServiceVanBanDen().chenHoSo(this.widget.id, this.hoSoId).then((value){
