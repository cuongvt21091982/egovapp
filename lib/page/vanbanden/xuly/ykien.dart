...
import 'package:egovapp/service/vanbanden/service-vanbandenfilexl.dart';
import 'package:egovapp/service/vanbanden/service-vanbandenxuly.dart';
import 'package:flutter/material.dart';
import 'package:html_editor_enhanced/html_editor.dart';
class YKienVanBanDen extends StatefulWidget
{
  const YKienVanBanDen({Key? key,
    required this.id,
    required this.title
  }) : super(key: key);
  final String title;
  final int id;
  @override
  _YKienVanBanDenState createState() => _YKienVanBanDenState();}
class _YKienVanBanDenState extends State<YKienVanBanDen>
{
  ...
  Future<void> actionForm() async
  {
    ...
    ServiceVanBanDenXuLy().updateXuLy(this.widget.id,valueContent, status, UserAuthSession.staffId  ).then((value) {
      ...
      for(var f in fileUploads)
      {
        ...
        {
          ServiceVanBanDenFileXL().add(value, f.path!);
        }
      }
