...
class VBDenChoGiaoXuLy extends StatefulWidget
{
  const VBDenChoGiaoXuLy({Key? key}) : super(key: key);
  @override
  _VBDenChoGiaoXuLyState createState() => _VBDenChoGiaoXuLyState();
}
class _VBDenChoGiaoXuLyState extends State<VBDenChoGiaoXuLy>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceVanBanDen().getPaging(keyword,maLoaiVB,maLinhVuc,ParamUtils.statusChoGiaoXuLy.toString(),
          phoCap, nguoiNhapId,nguoiChuTri,maNoiGui,ParamUtils.dateDefault,ParamUtils.dateDefault, page, size).then((value)
    {
      try {
        ...
        builderDelegate: PagedChildBuilderDelegate<VanBanDen>(
            ...
            itemBuilder: (context, item, index) =>  ListTile(
              ...
              onTap: (){
                ...
                new AssignVanBanDen(id: item.id, title: item.trichYeu, callBackRefresh: () =>
                    setState((){  searchVanBanDen();})
                )));
