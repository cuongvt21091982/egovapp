...
class VBDenDangXuLy extends StatefulWidget
{
  const VBDenDangXuLy({Key? key}) : super(key: key);
  @override
  _VBDenDangXuLyState createState() => _VBDenDangXuLyState();
}
class _VBDenDangXuLyState extends State<VBDenDangXuLy>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceVanBanDen().getPagingXuLy(keyword,maLoaiVB,maLinhVuc,ParamUtils.statusDangXuLy.toString(),
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("vanbandendangxuly"),
