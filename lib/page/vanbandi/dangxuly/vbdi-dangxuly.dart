...
class VBDiDangXuLy extends StatefulWidget
{
  const VBDiDangXuLy({Key? key}) : super(key: key);
  @override
  _VBDiDangXuLyState createState() => _VBDiDangXuLyState();
}
class _VBDiDangXuLyState extends State<VBDiDangXuLy>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceVanBanDi().getPagingXuLy(keyword,maLoaiVB,maLinhVuc,ParamUtils.statusDangXuLy.toString(),
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("vanbandidangxuly"),
