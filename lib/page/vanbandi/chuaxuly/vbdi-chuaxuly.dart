...
class VBDiChuaXuLy extends StatefulWidget
{
  const VBDiChuaXuLy({Key? key}) : super(key: key);
  @override
  _VBDiChuaXuLyState createState() => _VBDiChuaXuLyState();
}
class _VBDiChuaXuLyState extends State<VBDiChuaXuLy>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceVanBanDi().getPagingXuLy(keyword,maLoaiVB,maLinhVuc,ParamUtils.statusChuaXuLy.toString(),
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("vanbandichuaxuly"),
