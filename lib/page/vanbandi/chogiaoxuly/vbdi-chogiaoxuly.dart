...
import 'package:egovapp/page/vanbandi/xuly/assign.dart';
...
class VBDiChoGiaoXuLy extends StatefulWidget
{
  const VBDiChoGiaoXuLy({Key? key}) : super(key: key);
  @override
  _VBDiChoGiaoXuLyState createState() => _VBDiChoGiaoXuLyState();
}
class _VBDiChoGiaoXuLyState extends State<VBDiChoGiaoXuLy>
{
  int page = Enviroments.currentPage;
  int size= Enviroments.pageSize;
  int maLoaiVB=ParamUtils.valueDefault;
  int nhomVanBan=ParamUtils.valueDefault;
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceVanBanDi().getPaging(nhomVanBan, keyword,maLoaiVB,maLinhVuc,ParamUtils.statusChoGiaoXuLy.toString(),
        phoCap, nguoiNhapId,nguoiChuTri,fromDate,toDate, page, size).then((value)
    {
      try {
            ...
            itemBuilder: (context, item, index) =>  ListTile(
              ...
              title:Column(
                children: [
                  ...
                  Row(
                      children: <Widget>[
                        UIUtils.setTextAssignItem(Language.getText("nguoiky")+": "+ item.nguoiKy.fullName)
                      ])
                ],
              )
              ,
              onTap: (){
                ...
                new AssignVanBanDi(id: item.id, title: item.soVaoSo+" - "+ item.trichYeu, callBackRefresh: () =>
                    setState((){  searchVanBanDi();})
                )));
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("vanbandichogiaoxuly"),
