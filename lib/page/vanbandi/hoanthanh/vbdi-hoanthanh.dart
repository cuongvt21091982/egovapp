...
class VBDiHoanThanh extends StatefulWidget
{
  const VBDiHoanThanh({Key? key}) : super(key: key);
  @override
  _VBDiHoanThanhState createState() => _VBDiHoanThanhState();
}
class _VBDiHoanThanhState extends State<VBDiHoanThanh>
{
  ...
  Future<void> _fetchPage(int pageKey) async {
    ServiceVanBanDi().getPagingXuLy(keyword,maLoaiVB,maLinhVuc,ParamUtils.statusHoanThanh.toString(),
        ...
        appBar: AppBar(
          ...
          title:  TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: Language.getText("vanbandihoanthanh"),
