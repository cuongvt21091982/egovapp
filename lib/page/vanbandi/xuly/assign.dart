...
class AssignVanBanDi extends StatefulWidget
{
  const AssignVanBanDi({Key? key,
    required this.id,
    required this.title,
  ...
  final int id;
  @override
  _AssignVanBanDiState createState() => _AssignVanBanDiState();}
class _AssignVanBanDiState extends State<AssignVanBanDi>
{
  ...
  Future<void> actionForm() async
  {
    ...
    ServiceVanBanDi().addXuLy(this.widget.id,
  ...
  Widget build(BuildContext context) {
    ...
    return new WillPopScope(child:  Scaffold(
        appBar: AppBar(
          ...
          title: Text(Language.getText("giaoxulyvanbandi")),
          elevation: 0,
        ),
