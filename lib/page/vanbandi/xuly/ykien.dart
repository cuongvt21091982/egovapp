...
class YKienVanBanDi extends StatefulWidget
{
  const YKienVanBanDi({Key? key,
    required this.id,
    required this.title
  }) : super(key: key);
  final String title;
  final int id;
  @override
  _YKienVanBanDiState createState() => _YKienVanBanDiState();}
class _YKienVanBanDiState extends State<YKienVanBanDi>
{
  ...
  Future<void> actionForm() async
  {
    ...
    ServiceVanBanDiXuLy().updateXuLy(this.widget.id,valueContent, status, UserAuthSession.staffId  ).then((value) {
