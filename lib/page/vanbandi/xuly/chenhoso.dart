...
class VanBanDiChenHoSo extends StatefulWidget
{
  const VanBanDiChenHoSo({Key? key, required this.id}) : super(key: key);
  final int id;
  @override
  _VanBanDiChenHoSoState createState() => _VanBanDiChenHoSoState();
}
class _VanBanDiChenHoSoState extends State<VanBanDiChenHoSo>
{
  ...
  dynamic _insertHoSo() async
  {
    ...
    ServiceVanBanDi().chenHoSo(this.widget.id, this.hoSoId).then((value){
