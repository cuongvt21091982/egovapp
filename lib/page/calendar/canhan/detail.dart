...
class LichCaNhanDetail extends StatefulWidget
{
  const LichCaNhanDetail({Key? key, required this.id,
    required this.chuDe,
  ...
  @override
  _LichCaNhanDetailState createState() => _LichCaNhanDetailState();
}
class _LichCaNhanDetailState extends State<LichCaNhanDetail>
{
  String chuDe = '';
  @override
  void initState(){
  ...
  Widget build(BuildContext context) {
    var futureContent= FutureBuilder(
        future: ServiceCalendar().getById(this.widget.id).catchError((onError){
    ...
    return  new WillPopScope(
      ...
      child:  Scaffold(
        appBar: AppBar(
          ...
          title: Text(Language.getText("thongtinlichcanhan")),
