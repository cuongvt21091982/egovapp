...
import 'package:egovapp/page/calendar/congtac/app-congtac-xuly.dart';
...
class LichCongTacDetail extends StatefulWidget
{
  const LichCongTacDetail({Key? key, required this.id,
    required this.chuDe,
  ...
  @override
  _LichCongTacDetailState createState() => _LichCongTacDetailState();
}
class _LichCongTacDetailState extends State<LichCongTacDetail>
{
  String chuDe = '';
  @override
  void initState(){
  ...
  Widget build(BuildContext context) {
    var futureContent= FutureBuilder(
        future: ServiceCalendarNews().getById(this.widget.id).catchError((onError){
          ...
          switch (snapshot.connectionState) {
            ...
            default:
              if (snapshot.hasData == false)
                ...
                CalendarNews _calendarNews = snapshot.data;
    ...
    return  new WillPopScope(
      ...
      child:  Scaffold(
        appBar: AppBar(
          ...
          title: Text(Language.getText("thongtinlichcongtac")),
          actions: [AppBarLichCongTacXuLyAction(id: this.widget.id, title: this.chuDe,
              callBackRefresh: () =>
                  setState(() {
                    this.widget.callBackRefresh();
                  })
