...
class YKienCalendarDepart extends StatefulWidget
{
  const YKienCalendarDepart({Key? key,
    required this.year,
    required this.week,
    required this.title
  }) : super(key: key);
  ...
  final int week;
  @override
  _YKienCalendarDepartState createState() => _YKienCalendarDepartState();}
class _YKienCalendarDepartState extends State<YKienCalendarDepart>
{
  ...
  Future<void> actionForm() async
  {
    ...
    ServiceCalendarDepartComment().add(this.widget.week, this.widget.year,
        valueContent, UserAuthSession.staffId, UserAuthSession.unitId ).then((value) {
