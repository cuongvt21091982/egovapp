...
class _MyHomePageState extends State<MyHomePage> {
  final _documents = [
    {
      ...
      'link':
      'http://datafile.chinhphu.vn/file-remote-v2/DownloadServlet?filePath=vbpq/2021/07/23-qd.signed.pdf'
    },
    {
  ...
  static void downloadCallback(
    ...
    final SendPort send =
    IsolateNameServer.lookupPortByName('80')!;
  ...
  Future<bool> _openDownloadedFile(_TaskInfo? task) {
    if (task != null) {
      OpenFile.open(_localPath+"/23-qd.signed.pdf");
  ...
  Future<void> openFile() async {
    final _result = await OpenFile.open(_localPath+"/23-qd.signed.pdf");
