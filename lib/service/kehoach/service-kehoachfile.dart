...
final String apiUrl = ApiUtils().apiUrl+'/api/info/kehoachfile';
class ServiceKeHoachFile
{
  ...
  Future<List<KeHoachFile>> getAllByKeHoachId(int id) async {
    final response = await http.get(
    ...
    return responseJson.map((e) => KeHoachFile.fromJson(e)).toList();
