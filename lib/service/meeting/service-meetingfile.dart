...
final String apiUrl = ApiUtils().apiUrl+'/api/info/meetingfile';
class ServiceMeetingFile
{
  ...
  Future<List<MeetingFile>> getAllByMeetingId(int id) async {
    final response = await http.get(
    ...
    return responseJson.map((e) => MeetingFile.fromJson(e)).toList();
