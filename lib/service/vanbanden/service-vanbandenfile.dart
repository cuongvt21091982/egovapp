...
final String apiUrl = ApiUtils().apiUrl+'/api/info/vanbandenfile';
class ServiceVanBanDenFile
{
  ...
  Future<List<VanBanDenFile>> getAllByVanBanId(int id) async {
    final response = await http.get(
    ...
    return responseJson.map((e) => VanBanDenFile.fromJson(e)).toList();
