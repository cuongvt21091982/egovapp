...
final String apiUrl = ApiUtils().apiUrl+'/api/calendar/calendarfile';
class ServiceCalendarFile
{
  ...
  Future<List<CalendarFile>> getAllByCalendarId(int id) async {
    final response = await http.get(
    ...
    return responseJson.map((e) => CalendarFile.fromJson(e)).toList();
