...
final String apiUrl = ApiUtils().apiUrl+'/api/calendar/calendarnewsfile';
class ServiceCalendarNewsFile
{
  ...
  Future<List<CalendarNewsFile>> getAllByCalendarId(int id) async {
    final response = await http.get(
    ...
    return responseJson.map((e) => CalendarNewsFile.fromJson(e)).toList();
